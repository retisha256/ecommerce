...
router.post('/products', upload.single('image'), async (req, res) => {
    try {
        console.log('Creating product, req.file:', req.file ? req.file.filename : 'no file');
