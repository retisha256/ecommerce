...
-  **Real-time Statistics**: Pending orders, total orders, revenue tracking
- **Order Clearing**: Remove completed orders from the system
...
6. **Access the application**
    - Frontend: http://localhost:5003/index.html
...
├── routes/
│   ├── productRoutes.js    # Product and order routes
...
4. View pending orders with customer details and amounts
5. Mark orders as paid or clear completed orders
6. Monitor statistics: pending orders, total orders, revenue
7. Handle customer support via WhatsApp
